...
def find_partya(content, div):
    ...
    reg_three = re.search('(公司|局|院|馆|委员会|集团|室|部|中心|银行|管理处|人民政府)?(与|和)?([\w|\(|\)|（|）|\-|\.]+?)(公司|局|院|馆|委员会|集团|室|部|中心|银行|管理处|人民政府)((\(|（)(以)?下(简)?称(“(\w+)”|，|、|或|或者)*?“?(甲方|买方|销售方|业主方|业主|招标人|招标单位|招标方|发包人|发包方|分包人|采购单位))', content)
    ...
    if reg_one:
        ...
        if reg_three and re.search('招标', reg_three.group(3)) is None:
            if re.search('(公司|局|院|馆|委员会|集团|室|部|中心|银行|管理处|人民政府)?(与|和)?([\w|\(|\)|（|）|\-|\.]+?)(公司)((\(|（)(以)?下(简)?称(“(\w+)”|，|、|或|或者)*?“?(甲方|买方|销售方|业主方|业主|招标人|招标单位|招标方|发包人|发包方|分包人|采购单位))', content):
                partya_raw = re.search('(公司|局|院|馆|委员会|集团|室|部|中心|银行|管理处|人民政府)?(与|和)?([\w|\(|\)|（|）|\-|\.]+?)(公司)((\(|（)(以)?下(简)?称(“(\w+)”|，|、|或|或者)*?“?(甲方|买方|销售方|业主方|业主|招标人|招标单位|招标方|发包人|发包方|分包人|采购单位))', content)
            else:
                partya_raw = re.search('(公司|局|院|馆|委员会|集团|室|部|中心|银行|管理处|人民政府)?(与|和)?([\w|\(|\)|（|）|\-|\.]+?)(局|院|馆|委员会|集团|室|部|中心|银行|管理处|人民政府)((\(|（)(以)?下(简)?称(“(\w+)”|，|、|或|或者)*?“?(甲方|买方|销售方|业主方|业主|招标人|招标单位|招标方|发包人|发包方|分包人|采购单位))', content)
