...
def find_partya(content):
    reg_one = re.search('(和|与)([\w|\(|\)|（|）|\-|\.]+?)(公司|局|院|馆|委员会|集团|室|部|中心|银行)([\w|“|”|\n|（|）]*?)(签订|签署)', content)
    reg_two = re.search('(收到|接到|获|获得|中标|参与)(了)?(由)?(甲方|买方|销售方|业主方|业主|招标人|招标单位|招标方|发包人|发包方|分包人)?([\w|\(|\)|（|）|\-|\.]+?)(公司|局|院|馆|委员会|集团|室|部|中心|银行)', content)
    reg_three = re.search('(公司|局|院|馆|委员会|集团|室|部|中心|银行)?(与|和)?([\w|\(|\)|（|）|\-|\.]+?)(公司|局|院|馆|委员会|集团|室|部|中心|银行)((\(|（)(以)?下(简)?称(“(\w+)”|，|、|或|或者)*?“(甲方|买方|销售方|业主方|业主|招标人|招标单位|招标方|发包人|发包方|分包人)”)', content)
    ...
    if reg_one:
        ...
        if reg_three:
            if re.search('(公司|局|院|馆|委员会|集团|室|部|中心|银行)?(与|和)?([\w|\(|\)|（|）|\-|\.]+?)(公司)((\(|（)(以)?下(简)?称(“(\w+)”|，|、|或|或者)*?“(甲方|买方|销售方|业主方|业主|招标人|招标单位|招标方|发包人|发包方|分包人)”)', content):
                partya_raw = re.search('(公司|局|院|馆|委员会|集团|室|部|中心|银行)?(与|和)?([\w|\(|\)|（|）|\-|\.]+?)(公司)((\(|（)(以)?下(简)?称(“(\w+)”|，|、|或|或者)*?“(甲方|买方|销售方|业主方|业主|招标人|招标单位|招标方|发包人|发包方|分包人)”)', content)
            else:
                partya_raw = re.search('(公司|局|院|馆|委员会|集团|室|部|中心|银行)?(与|和)?([\w|\(|\)|（|）|\-|\.]+?)(局|院|馆|委员会|集团|室|部|中心|银行)((\(|（)(以)?下(简)?称(“(\w+)”|，|、|或|或者)*?“(甲方|买方|销售方|业主方|业主|招标人|招标单位|招标方|发包人|发包方|分包人)”)', content)
