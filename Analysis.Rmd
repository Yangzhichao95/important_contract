...
temp <- hetong_train[hetong_train[,1] %in% result_project$Error, c(1,2,3,4)]
temp1 <- hetong_trainresult[hetong_trainresult[,1] %in% result_project$Error,c(1,2,3,4)]
temp1 <- temp1[order(temp1[,1]),]
...
temp <- hetong_train[hetong_train[,1] %in% result_contract$Error, c(1,2,3,8)]
temp1 <- hetong_trainresult[hetong_trainresult[,1] %in% result_contract$Error,c(1,2,3,8)]
temp1 <- temp1[order(temp1[,1]),]
...
temp <- hetong_train[hetong_train[,1] %in% result_money_up$Error, c(1,2,3,8)]
temp1 <- hetong_trainresult[hetong_trainresult[,1] %in% result_money_up$Error,c(1,2,3,8)]
temp1 <- temp1[order(temp1[,1]),]
...
temp <- hetong_train[hetong_train[,1] %in% result_money_low$Error, c(1,2,3,8)]
temp1 <- hetong_trainresult[hetong_trainresult[,1] %in% result_money_low$Error,c(1,2,3,8)]
temp1 <- temp1[order(temp1[,1]),]
...
temp1 <- hetong_trainresult[hetong_trainresult[,1] %in% result_combo$Error,c(1,2,3,8)]
temp1 <- temp1[order(temp1[,1]),]
...
for(i in 1 : nrow(hetong_trainresult)){
  vector_trainresult <- c(vector_trainresult, tolower(paste(hetong_trainresult[i,c(1,5)],collapse = '')))
}
